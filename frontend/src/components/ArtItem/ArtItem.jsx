...
const ArtItem = ({ id, name, price, description, image, genre }) => {
  ...
  return (
    <div className='art-item'>
      ...
      <div className="art-item-info">
        ...
        <p className="art-item-genre"><strong>Genre:</strong> {genre}</p>
        {location.pathname !== '/' && <p className="art-item-desc">{description}</p>}
